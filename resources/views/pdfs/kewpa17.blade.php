...
<body class="p-8 text-[10px] leading-tight bg-white font-serif text-black">
    ...
    <div class="flex justify-between items-start mb-1">
        ...
        <div class="text-right">
            <div class="font-bold text-[14px]">KEW.PA-17</div>
    ...
    <div class="text-center font-bold text-[13px] mb-6 uppercase">PERMOHONAN/PERAKUAN PELUPUSAN HARTA UTM</div>
    ...
    <table class="w-full border-collapse border border-black text-center">
        <thead class="bg-gray-50 font-bold">
            <tr>
                ...
                <th class="border border-black p-1.5 text-left">Sebab Pelupusan</th>
                <th class="border border-black p-1.5">Kaedah</th>
        ...
        <tbody>
            @forelse($asset->disposals as $index => $d)
                <tr class="h-8">
                    <td class="border border-black p-1.5">{{ $index + 1 }}</td>
                    <td class="border border-black p-1.5 text-left uppercase">{{ $d->request_reason }}</td>
                    ...
                    <td class="border border-black p-1.5 uppercase">{{ $d->status }}</td>
                    <td class="border border-black p-1.5"></td>
                </tr>
            @empty
                <tr class="h-8">
                    <td class="border border-black p-1.5 italic text-gray-500" colspan="7">Tiada rekod pelupusan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
