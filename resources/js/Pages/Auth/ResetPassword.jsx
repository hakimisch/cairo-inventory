...
export default function ResetPassword({ token, email }) {
    const { data, setData, post, processing, errors, reset } = useForm({ token: token, email: email, password: '', password_confirmation: '' });
    ...
    return (
        <GuestLayout>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                ...
                <h2 style={{ fontSize: '20px', fontWeight: 800, color: UTM.maroon, margin: 0 }}>Reset Password</h2>
            </div>

            <form onSubmit={submit}>
                <div style={{ marginBottom: 20 }}>
                    <label style={labelStyle} htmlFor="email">Email</label>
                    <input id="email" type="email" name="email" value={data.email} style={inputStyle} autoComplete="username" onChange={(e) => setData('email', e.target.value)} />
                ...
                <div style={{ marginBottom: 20 }}>
                    ...
                    <input id="password" type="password" name="password" value={data.password} style={inputStyle} autoComplete="new-password" autoFocus onChange={(e) => setData('password', e.target.value)} />
                ...
                <div style={{ marginBottom: 20 }}>
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" value={data.password_confirmation} style={inputStyle} autoComplete="new-password" onChange={(e) => setData('password_confirmation', e.target.value)} />
