...
const UTM = {
    ...
    white: '#FFFFFF', gray50: '#F9F7F5', gray100: '#EDE9E4', gray200: '#D8D3CC',
...
const thStyle = {
    padding: '9px 14px', fontSize: '10px', fontWeight: 700, letterSpacing: '0.07em',
    textTransform: 'uppercase', color: UTM.gray500, textAlign: 'left',
    borderBottom: `2px solid ${UTM.gray100}`, background: UTM.gray50, whiteSpace: 'nowrap',
};
 
export default function Kewpa4({ assets, year, years, locations, totalValue, totalCount }) {
    const [selYear, setSelYear]     = useState(String(year));
    const [selLoc, setSelLoc]       = useState('');
 
    const applyFilter = () => {
        router.get(route('reports.kewpa4'), { year: selYear, location: selLoc }, { preserveState: true });
    };
    ...
    return (
        <AuthenticatedLayout header={
            ...
            <Head title="KEW.PA-4 Senarai Harta Tetap" />
            ...
            <div style={{ background: UTM.gray50, minHeight: '100vh', padding: '24px' }}>
                <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    <div className="no-print" style={{
                        ...
                        <div>
                            <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase',
                                            letterSpacing: '0.07em', color: UTM.gray500, display: 'block',
                                            marginBottom: 5 }}>Tahun</label>
                        ...
                        <div>
                            <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase',
                                            letterSpacing: '0.07em', color: UTM.gray500, display: 'block',
                                            marginBottom: 5 }}>Lokasi / Unit</label>
                        ...
                        <div style={{ flex: 1 }} />
                        <a href={route('reports.kewpa4.download') + `?year=${selYear}`}
                    ...
                    <div style={{ background: UTM.white, borderRadius: 10,
                        ...
                        {/* Header */}
                        <div style={{ textAlign: 'right', fontWeight: 700, marginBottom: 4 }}>KEW.PA-4</div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 20 }}>
                            <thead>
                                <tr style={{ background: '#f0f0f0', fontWeight: 700, fontSize: '10px',
                                    ...
                                    <th style={{ border: '1px solid #000', padding: '6px 8px', width: '13%' }}>
                            ...
                            <tbody>
                                {assets.length === 0 ? (
                                    <tr>
                                        <td colSpan={6} style={{ border: '1px solid #000', padding: '20px',
                                            ...
                                            Tiada rekod harta tetap bagi tahun {year}.
                                        </td>
                                    </tr>
                                ) : assets.map((a, i) => (
                                ...
                                <tr style={{ fontWeight: 700, background: '#f0f0f0' }}>
                                    <td colSpan={5} style={{ border: '1px solid #000', padding: '6px 8px',
                                        ...
                                        Jumlah Keseluruhan ({totalCount} aset)
                                    </td>
                        ...
                        <p style={{ marginTop: 20, fontSize: '10px', color: UTM.gray500, fontStyle: 'italic' }}>
                            * Laporan merangkumi semua aset tetap yang diterima bagi tahun {year}
                        </p>
                    </div>
                </div>
            </div>
