...
export default function Kewpa18({ disposals }) {
    return (
        <AuthenticatedLayout>
            <Head title="KEW.PA-18 — Sijil Pemusnahan" />

            <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
                {/* ── Header ─────────────────────────────────────────────── */}
                <div style={{ marginBottom: 28 }}>
                    <h1 style={{ fontSize: 22, fontWeight: 800, color: UTM.maroon, margin: 0 }}>
                        KEW.PA-18 — Sijil Pemusnahan
                    </h1>
                    <p style={{ fontSize: 13, color: UTM.gray500, marginTop: 4 }}>
                        Destruction Certificate — Rekod pemusnahan aset (Tanam / Bakar / Tenggelam)
                    </p>
                </div>
                ...
                <div style={{
                        ...
                        <table style={{ width: '100%', minWidth: 900, borderCollapse: 'collapse' }}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={thStyle}>Kaedah Pemusnahan</th>
                                ...
                                {disposals.length === 0 ? (
                                    <tr>
                                        <td colSpan={7} style={{ ...tdStyle, textAlign: 'center', color: UTM.gray500 }}>
                                            Tiada rekod pemusnahan aset (Tanam / Bakar / Tenggelam).
                                        </td>
                                    </tr>
                                    ...
                                    <tr key={disposal.id} style={{
                                        ...
                                        <td style={{ ...tdStyle, whiteSpace: 'nowrap' }}>
                                            <a
                                                href={route('disposals.kewpa18.download', disposal.id)}
                                                style={{
                                                    display       : 'inline-block',
                                                    padding       : '4px 12px',
                                                    borderRadius  : 4,
                    ...
                    <div style={{
                        ...
                        Menunjukkan <strong style={{ color: UTM.maroon }}>{disposals.length}</strong> rekod pemusnahan
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
