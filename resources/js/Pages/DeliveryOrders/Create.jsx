        ...
        <AuthenticatedLayout>
            ...
            <div style={{ padding: 24, maxWidth: 800, margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: 24 }}>
                    ...
                    <h1 style={{ fontSize: 22, fontWeight: 700, margin: '8px 0 0' }}>New Delivery Order</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ backgroundColor: '#fff', borderRadius: 12, border: '1px solid #E5E7EB', padding: 24 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                        <div>
                            ...
                            <input type="text" value={data.do_no} onChange={e => setData('do_no', e.target.value)}
                                placeholder="e.g. UTMCAIRO/26/005"
                                style={inputStyle} />
                        ...
                        <div>
                            ...
                            <input type="text" value={data.po_reference} onChange={e => setData('po_reference', e.target.value)}
                                placeholder="e.g. PPTK170300122025000272"
                                style={inputStyle} />
                        </div>
                        <div>
                        ...
                        <div>
                            <label style={labelStyle}>Upload DO Document (PDF)</label>
