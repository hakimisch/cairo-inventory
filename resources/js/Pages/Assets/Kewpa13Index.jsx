...
export default function Kewpa13Index({ records, filters }) {
    const [search, setSearch] = useState(filters?.search || '');
    const [statusFilter, setStatusFilter] = useState(filters?.status || '');

    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('maintenances.index'), { search, status: statusFilter }, { preserveState: true, replace: true });
    };

    const handleReset = () => {
        setSearch('');
        setStatusFilter('');
        router.get(route('maintenances.index'), {}, { preserveState: true, replace: true });
    };
            ...
            <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px' }}>
                ...
                <div style={{ marginBottom: 28 }}>
                    <h1 style={{ fontSize: 22, fontWeight: 800, color: UTM.maroon, margin: 0 }}>
                        KEW.PA-13/14 — Rekod Penyelenggaraan Aset
                    </h1>
                    <p style={{ fontSize: 13, color: UTM.gray500, marginTop: 4 }}>
                        Senarai rekod penyelenggaraan aset
                    </p>
                </div>
                ...
                <form onSubmit={handleSearch} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 200 }}>
                        ...
                        <input
                            ...
                            placeholder="Nama aset, tag, syarikat, kontrak..."
                            style={inputStyle}
                        />
                    </div>
                            ...
                            {records.data.length === 0 ? (
                                <tr>
                                    <td colSpan={8} style={{ ...tdStyle, textAlign: 'center', color: UTM.gray500 }}>
                                        Tiada rekod penyelenggaraan aset.
                                    </td>
                                </tr>
