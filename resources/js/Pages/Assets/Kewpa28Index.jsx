...
export default function Kewpa28Index({ records, filters }) {
    const [search, setSearch] = useState(filters?.search || '');
    const [statusFilter, setStatusFilter] = useState(filters?.status || '');

    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('loss-reports.index'), { search, status: statusFilter }, { preserveState: true, replace: true });
    };

    const handleReset = () => {
        setSearch('');
        setStatusFilter('');
        router.get(route('loss-reports.index'), {}, { preserveState: true, replace: true });
    };
            ...
            <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px' }}>
                ...
                <div style={{ marginBottom: 28 }}>
                    <h1 style={{ fontSize: 22, fontWeight: 800, color: UTM.maroon, margin: 0 }}>
                        KEW.PA-28→32 — Laporan Kehilangan Aset
                    </h1>
                    <p style={{ fontSize: 13, color: UTM.gray500, marginTop: 4 }}>
                        Senarai laporan kehilangan aset
                    </p>
                </div>
                ...
                <form onSubmit={handleSearch} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 200 }}>
                        ...
                        <input
                            ...
                            placeholder="Nama aset, tag, no. laporan polis, lokasi..."
                            style={inputStyle}
                        />
                    </div>
